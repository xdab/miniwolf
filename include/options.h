...
#define OPT_SHORT_KISS 1
#define OPT_SHORT_DEV_NAME 'd'
#define OPT_SHORT_DEV_INPUT 'i'
#define OPT_SHORT_DEV_OUTPUT 'o'
#define OPT_SHORT_RATE 'r'
#define OPT_SHORT_TCP_KISS_PORT 2
#define OPT_SHORT_TCP_TNC2_PORT 3
#define OPT_SHORT_UDP_KISS_ADDR 4
#define OPT_SHORT_UDP_KISS_PORT 5
#define OPT_SHORT_UDP_TNC2_ADDR 6
#define OPT_SHORT_UDP_TNC2_PORT 7
#define OPT_SHORT_UDP_KISS_LISTEN_PORT 8
#define OPT_SHORT_UDP_TNC2_LISTEN_PORT 9
#define OPT_SHORT_UDS_KISS_SOCKET 10
#define OPT_SHORT_UDS_TNC2_SOCKET 11
